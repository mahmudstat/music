(function IIFE() {
...

  {
    id: 2,
    url:
    "../songs/group/ujjibon/protyashar_alo/02_noyonaviram.mp3",
    author: "প্রত্যাশার আলো",
    title: "নয়নাভিরাম",
    cover:
    "../img/player/player.jpg"},

  {
    id: 3,
    url:
    "../songs/group/ujjibon/protyashar_alo/03_dur_arober.mp3",
    author: "প্রত্যাশার আলো",
    title: "দূর আরবের",
    cover:
    "../img/player/player.jpg"},
...

  {
    id: 5,
    url:
    "../songs/group/ujjibon/protyashar_alo/05_holud_paki.mp3",
    author: "প্রত্যাশার আলো",
    title: "হলুদ পাখি",
    cover:
    "../img/player/player.jpg"},
...

  {
    id: 14,
    url:
    "../songs/group/ujjibon/protyashar_alo/14_digonto_nil_chuyen.mp3",
    author: "প্রত্যাশার আলো",
    title: "দিগন্ত নীল ছুঁয়ে",
    cover:
    "../img/player/player.jpg"}];
